    ...
    child: Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(caseType, style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16.sp, color: ColorPalette.grey),),
    ...
    child: Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(date, style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16.sp, color: ColorPalette.grey),),
          Text(name, style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16.sp, color: ColorPalette.grey),),
          Text(state, style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16.sp, color: ColorPalette.grey),),
          Text(lga, style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16.sp, color: ColorPalette.grey),),
          Text(facility, style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16.sp, color: ColorPalette.grey),),
        ],
      ),
    ),
  );
    ...
    child: Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(date, style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16.sp, color: ColorPalette.grey),),
          Text(name, style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16.sp, color: ColorPalette.grey),),
          Text(groupId, style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16.sp, color: ColorPalette.grey),),
        ],
      ),
    ),
  );
